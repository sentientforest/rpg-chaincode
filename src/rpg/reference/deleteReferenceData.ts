...
export async function deleteWeaponData(ctx: GalaChainContext, dto: DeleteReferenceDataDto): Promise<void> {
...
export async function deleteArmorData(ctx: GalaChainContext, dto: DeleteReferenceDataDto): Promise<void> {
...
export async function deleteSkillData(ctx: GalaChainContext, dto: DeleteReferenceDataDto): Promise<void> {
...
export async function deleteFeatData(ctx: GalaChainContext, dto: DeleteReferenceDataDto): Promise<void> {
...
export async function deleteSpellData(ctx: GalaChainContext, dto: DeleteReferenceDataDto): Promise<void> {
