...
import { CharacterEntity, CreatePartyDto, PartyEntity, PartyTreasury } from "../types";

export async function createParty(ctx: GalaChainContext, dto: CreatePartyDto): Promise<void> {
