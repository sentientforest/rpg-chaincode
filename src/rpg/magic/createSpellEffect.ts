...
import { CastSpellAction, EncounterEntity, SpellEffect } from "../types";
...
export async function createSpellEffect(ctx: GalaChainContext, dto: CreateSpellEffectDto): Promise<void> {
...
export async function updateSpellEffect(ctx: GalaChainContext, dto: UpdateSpellEffectDto): Promise<void> {
